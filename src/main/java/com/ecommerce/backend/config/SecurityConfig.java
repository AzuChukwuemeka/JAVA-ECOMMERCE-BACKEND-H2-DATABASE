...
/**
 * Configures stateless JWT-based security: public read access to the catalog,
 * authenticated access to cart/orders, and admin-only access to catalog mutation.
 */
@Configuration
@EnableWebSecurity
